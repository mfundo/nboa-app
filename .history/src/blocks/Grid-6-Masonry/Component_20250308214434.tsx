    ...
    <section className={cn('hanken container')}>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-1 row-span-1">
          <div className="h-50 bg-gray-200 flex items-center justify-center">Left Top</div>
        ...
        <div className="col-span-1 row-span-1">
          <div className="h-50 bg-gray-200 flex items-center justify-center">Right Top</div>
          <p className="text-center mt-2">Caption for Right Top</p>
        </div>

        <div className="col-span-1 row-span-1">
          <div className="h-50 bg-gray-200 flex items-center justify-center">Left Bottom</div>
        ...
        <div className="col-span-1 row-span-1">
          <div className="h-50 bg-gray-200 flex items-center justify-center">Right Bottom</div>
