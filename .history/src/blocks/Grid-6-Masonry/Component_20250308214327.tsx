    ...
    <section className={cn('hanken container')}>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-1 row-span-2">
          <div className="h-96 bg-gray-300 flex items-center justify-center">Middle Tall 1</div>
        ...
        <div className="col-span-1 row-span-2">
          <div className="h-96 bg-gray-300 flex items-center justify-center">Middle Tall 2</div>
