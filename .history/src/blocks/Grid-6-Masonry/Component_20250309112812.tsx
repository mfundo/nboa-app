    ...
    <section className={cn('hanken container')}>
      ...
      <div className="flex gap-4">
        ...
        <div className="flex flex-col w-1/3">
          <div className="bg-gray-200 flex flex-col items-center justify-center h-[280px]">
            <Image
          ...
          <div className="bg-gray-200 flex flex-col items-center justify-center h-[280px] mt-4">
            <Image
        ...
        <div className="flex flex-col w-1/3">
          ...
          <div className="bg-gray-300 flex flex-col items-center justify-center h-[310px]">
            <Image
          ...
          <div className="bg-gray-300 flex flex-col items-center justify-center h-[310px] mt-4>
            <Image
              src="/path/to/middle-tall-image.jpg"
              alt="Middle Tall Image"
              width={300}
