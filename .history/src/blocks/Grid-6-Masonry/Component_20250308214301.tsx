    ...
    <section className={cn('hanken container')}>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-1 row-span-1">
          <div className="h-406 bg-gray-200 flex items-center justify-center">Left Top</div>
          <p className="text-center mt-2">Caption for Left Top</p>
        </div>

        <div className="col-span-1 row-span-2">
          <div className="h-430 bg-gray-300 flex items-center justify-center">Middle Tall 1</div>
          <p className="text-center mt-2">Caption for Middle Tall 1</p>
        </div>

        <div className="col-span-1 row-span-1">
          <div className="h-406 bg-gray-200 flex items-center justify-center">Right Top</div>
          <p className="text-center mt-2">Caption for Right Top</p>
        </div>

        <div className="col-span-1 row-span-1">
          <div className="h-406 bg-gray-200 flex items-center justify-center">Left Bottom</div>
          <p className="text-center mt-2">Caption for Left Bottom</p>
        </div>

        <div className="col-span-1 row-span-2">
          <div className="h-430 bg-gray-300 flex items-center justify-center">Middle Tall 2</div>
          <p className="text-center mt-2">Caption for Middle Tall 2</p>
        </div>

        <div className="col-span-1 row-span-1">
          <div className="h-406 bg-gray-200 flex items-center justify-center">Right Bottom</div>
