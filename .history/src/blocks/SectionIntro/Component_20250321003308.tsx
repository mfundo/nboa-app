...
export function SectionIntroBlock(props: SectionIntroProps) {
  ...
  return (
    ...
    <section className={cn('hanken container mt-[110px]')}>

      <h2 className='text-[#FDB73E] text-[32px] font-semibold mb-5'>
        {title}
      </h2>

      <div className={cn('flex justify-around min-h-[550px] bg-[#FDB73E] p-10 pb-[70px]')}>
        ...
        <div className='w-2/3 flex space-x-5 -mt-[110px]'>
          ...
          <div className='w-1/3 flex flex-col items-center justify-center space-y-5'>
