...
export function FeaturedContentBlock(props: FeaturedContentProps) {
  ...
  return (
    ...
    <div className={cn('hanken container')}>
      ...
      <h2 className='text-[#FDB73E] place-content-center text-[40px] font-semibold mb-5'>
        {title}
      </h2>
      ...
      <div className={cn('flex justify-around items-center min-h-[480px]', {
        ...
        <div className='w-1/2 bg-[#FDB73E] px-10 text-[#FFF] '>
