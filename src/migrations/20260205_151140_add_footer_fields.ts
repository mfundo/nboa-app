...
export async function up({ db, payload: _payload, req: _req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_featured_banner_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_image_grid_layout" AS ENUM('newspaper', 'gallery', 'equal');
  CREATE TYPE "public"."enum_pages_blocks_service_cards_cards_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_content_with_image_image_position" AS ENUM('left', 'right');
  CREATE TYPE "public"."enum_pages_blocks_carousel_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum_pages_blocks_carousel_relation_to" AS ENUM('posts');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_featured_banner_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_image_grid_layout" AS ENUM('newspaper', 'gallery', 'equal');
  CREATE TYPE "public"."enum__pages_v_blocks_service_cards_cards_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_content_with_image_image_position" AS ENUM('left', 'right');
  CREATE TYPE "public"."enum__pages_v_blocks_carousel_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum__pages_v_blocks_carousel_relation_to" AS ENUM('posts');
  ...
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('facebook', 'twitter', 'instagram', 'linkedin', 'youtube');
  ...
  CREATE TABLE "pages_blocks_featured_banner" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"rich_text" jsonb,
  	"enable_link" boolean,
  	"link_type" "enum_pages_blocks_featured_banner_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE "pages_blocks_image_grid" (
  	...
  	"layout" "enum_pages_blocks_image_grid_layout" DEFAULT 'newspaper',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_service_cards_cards" (
  	...
  	"description" varchar,
  	"enable_link" boolean,
  	"link_type" "enum_pages_blocks_service_cards_cards_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar
  );
  ...
  CREATE TABLE "pages_blocks_content_with_image" (
  	...
  	"rich_text" jsonb,
  	"media_id" integer,
  	"image_position" "enum_pages_blocks_content_with_image_image_position" DEFAULT 'left',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_carousel" (
  	...
  	"relation_to" "enum_pages_blocks_carousel_relation_to" DEFAULT 'posts',
  ...
  CREATE TABLE "_pages_v_blocks_featured_banner" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"rich_text" jsonb,
  	"enable_link" boolean,
  	"link_type" "enum__pages_v_blocks_featured_banner_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"_uuid" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_image_grid" (
  	...
  	"heading" varchar,
  	"heading_accent" varchar,
  	"layout" "enum__pages_v_blocks_image_grid_layout" DEFAULT 'newspaper',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_service_cards_cards" (
  	...
  	"description" varchar,
  	"enable_link" boolean,
  	"link_type" "enum__pages_v_blocks_service_cards_cards_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"_uuid" varchar
  ...
  CREATE TABLE "_pages_v_blocks_content_with_image" (
  	...
  	"rich_text" jsonb,
  	"media_id" integer,
  	"image_position" "enum__pages_v_blocks_content_with_image_image_position" DEFAULT 'left',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_carousel" (
  	...
  	"relation_to" "enum__pages_v_blocks_carousel_relation_to" DEFAULT 'posts',
  	"limit" numeric DEFAULT 8,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  ALTER TABLE "pages_blocks_featured_banner" ADD CONSTRAINT "pages_blocks_featured_banner_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_content_with_image" ADD CONSTRAINT "pages_blocks_content_with_image_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_featured_banner" ADD CONSTRAINT "_pages_v_blocks_featured_banner_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_content_with_image" ADD CONSTRAINT "_pages_v_blocks_content_with_image_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_featured_banner_order_idx" ON "pages_blocks_featured_banner" USING btree ("_order");
  CREATE INDEX "pages_blocks_featured_banner_parent_id_idx" ON "pages_blocks_featured_banner" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_featured_banner_path_idx" ON "pages_blocks_featured_banner" USING btree ("_path");
  ...
  CREATE INDEX "pages_blocks_content_with_image_media_idx" ON "pages_blocks_content_with_image" USING btree ("media_id");
  ...
  CREATE INDEX "_pages_v_blocks_featured_banner_order_idx" ON "_pages_v_blocks_featured_banner" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_featured_banner_parent_id_idx" ON "_pages_v_blocks_featured_banner" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_featured_banner_path_idx" ON "_pages_v_blocks_featured_banner" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_content_with_image_media_idx" ON "_pages_v_blocks_content_with_image" USING btree ("media_id");
...
export async function down({ db, payload: _payload, req: _req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_featured_banner" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_featured_banner" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_featured_banner_link_type";
  DROP TYPE "public"."enum_pages_blocks_image_grid_layout";
  DROP TYPE "public"."enum_pages_blocks_service_cards_cards_link_type";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_featured_banner_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_image_grid_layout";
  DROP TYPE "public"."enum__pages_v_blocks_service_cards_cards_link_type";
